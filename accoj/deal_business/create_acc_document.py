...
def cal_acc_document(company):
    ...
    for i in range(0, entry_len):
        ...
        for entry_info in entry_infos:
            ...
            if is_dr:
                dr_sum += money
                contents.append({"summary": None, "general_account": subject, "detail_account": None, "dr_money": money,
                                 "cr_money": 0})
            else:
                cr_sum += money
                contents.append({"summary": None, "general_account": subject, "detail_account": None, "dr_money": 0,
                                 "cr_money": money})
        contents.append({"summary": "sum", "general_account": "sum", "detail_account": "sum", "dr_money": round(dr_sum, 2),
