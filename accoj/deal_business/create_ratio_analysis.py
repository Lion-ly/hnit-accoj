...
def cal_ratio_analysis(company):
    ...
    def get_subject_last_end(subject):
        subject_infos = new_balance_sheet_infos.get(subject)
        subject_info_last = subject_infos.get("period_last")
        subject_info_end = subject_infos.get("period_end")
        return subject_info_end, subject_info_last


    def get_subject_last_end_1(subject):
