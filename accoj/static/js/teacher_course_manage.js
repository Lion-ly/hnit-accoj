                ...
                columns: [
                    ...
                    {data: 'reason'},
                    {
                        data: null, 'render': function (data, type, row) {
                            let btn = "<button type=\"button\" style=\"margin-right:10px\" class=\"btn btn-primary btn-sm\" redo-agree-button onclick='bindButton(\"/api/course_reform\", \"agree\")' >通过</button>" +
