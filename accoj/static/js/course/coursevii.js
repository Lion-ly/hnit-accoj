...
function vii1_AddRow(flag) {
    ...
    $("#" + obj).before(
        ...
        + "<td colspan='10' id='borrow" + now_id + "' style='display: none;'  ><label><input onblur='input_replace_blur(event)' oninput='limit_input(this)'></label></td>"
        ...
        + "<td class='borrow" + now_id + "' onclick='input_replace_on(event)'><label><input onkeyup='limit_number(this)'></label></td>"
        + "<td class='borrow" + now_id + "' onclick='input_replace_on(event)'><label><input onkeyup='limit_number(this)'></label></td>"
        + "<td colspan='10' id='lend" + now_id + "' style='display: none;' ><label><input onblur='input_replace_blur(event)' oninput='limit_input(this)'></label></td>"
        ...
        + "<td colspan='10' id='balance" + now_id + "' style='display: none;' ><label><input onblur='input_replace_blur(event)' oninput='limit_input(this)'></label></td>"
